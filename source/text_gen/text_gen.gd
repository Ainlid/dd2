...
const articles = ["the", "my", "your", "our", "that", "this", "every", "one", "the only", "his", "her"]
...
const verbs = ["is", "was", "will be", "might be", "was never", "moves", "moved", "will move", "will end", "plays", "responded", "thinks", "is thinking", "waited", "waits", "enjoys", "hates", "illuminates", "faded", "transformed", "knows", "is working", "is calling", "stops", "continues", "speaks", "was speaking", "won", "lost", "is building", "destroyed", "is considering"]
...
func _make_sentence():
	var sentence = ""
	sentence += _rand_art() + " " + _rand_adj() + " " + _rand_noun() + " " + _rand_verb()
	sentence +=  " " + _rand_prep() + " " + _rand_art() + " " + _rand_adj() + " " + _rand_noun()
